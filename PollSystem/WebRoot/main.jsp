...
<link href="ezhestyle.css" rel="stylesheet" type="text/css" />
</head>
<style>
<!--
...
<div id="daohang">
  <ul>
    ...
    <li><a href="settype2.jsp">安排内容</a></li>
    <li><a href="settype3.jsp">安排时间</a></li>
...
<div id="links">
  <ul>
    <li class="neirong"><a href="index.jsp">安排适当的内容</a></li>
    <li class="shijian"><a href="main.jsp">选择合适的时间</a></li>
  </ul></div>
<div id="content">
<ul>
<li class="special2">咕咕帮您安排时间</li>
<li>吃饭、聚会、旅游等活动的时间安排,想选择出一个适合大多数人的时间时 ...</li>
   <li class="special1"><a href="settype.jsp?type=2">点击这里安排一个时间&gt;&gt;</a>&nbsp;&nbsp;<img src="bg5.jpg" /></li>
</ul>
</div>
</div>
