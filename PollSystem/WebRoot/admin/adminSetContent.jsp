...
<div id="daohang">
<ul>
	<li><a href="../index.jsp">p咕咕首页</a></li>
...
//System.out.println(countValue);
		for(int i=0;i<countValue+1;i++){
 		...
 		if(submitType!=null){
	 		...
	 		if(submitType.equals("增加选项数目")){
	 			...
	 			response.sendRedirect("adminPollModified.jsp");
	 			return;
	 		}
 		}	
 ...
 %>
     ...
     <form name="form1" method="post" action="adminSetContent.jsp" >
      <input type="hidden" name="action" value="submit"/>
	 <div id="biaodan1">
	 <span class="warning1">注意：重设选项后可能会对已投票的参加者的结果造成影响！</span><br />
	<span class="warning" id="optionwarning"></span>
	   <p><span class="special">修改内容（共两步）：</span><span>修改每个参加者将能选择的选项</span></p>
		    <% 
